...
void loop() 
{
  float si7021_cel = si7021.readTemperature(TEMP_C);   // Reading temperature in Celsius
  float si7021_fah = si7021.readTemperature(TEMP_F);   // Reading temperature in Fahrenheit
